...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initMobileHeaderMenu() {
        ...
        // Get or create mobile hamburger menu button
        let menuBtn = headerContainer.querySelector('.mobile-menu-toggle');
        ...
        // Populate mobile action buttons inside mobile nav if header-actions exists
        ...
        // Close mobile menu on clicking any direct link inside nav
